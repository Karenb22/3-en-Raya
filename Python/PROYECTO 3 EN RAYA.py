...
#Uso la función 'def' para imprimir el tablero 
...
#Se usa la función para comprobar el jugador ganador 
...
#Función que se aplica para comprobar que el juego está empatado 
...
#Se utiliza 'try' para escoger el movimiento del jugador  
        try:
            ...
            continue
#Verifica si el movimiento está dentro del rango 
        if move < 1 or move > 9:
            print("Error!!! Vuelve a intentarlo")
            continue
...
#Función que verifica al ganador 
        if check_win(player_pos, cur_player):
            ...
            print("\n")
            return cur_player
#Función que verifica si el juego está empatado 
...
#Se efectúa el bucle hasta que los jugadores renuncien  
    while True:
